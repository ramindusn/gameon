...
export function Button({
  ...
  return (
    <button
      className={cx(
        'inline-flex min-h-[2.75rem] items-center justify-center gap-1.5 rounded-lg px-3.5 py-2 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-offset-bg disabled:cursor-not-allowed disabled:opacity-50',
        variants[variant],
        className,
      )}
